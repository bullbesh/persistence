...
def yearly_report():	
	data = list()
	total_revenue = list()
	income_statement = (str(investpy.stocks.get_stock_financial_summary(stock='CHMF', country='Russia', summary_type='income_statement', period='annual'))).split('\n')
...
def quartely_report():
	data = list()
	total_revenue = list()
	income_statement = (str(investpy.stocks.get_stock_financial_summary(stock='CHMF', country='Russia', summary_type='income_statement', period='quarterly'))).split('\n')
	for value in income_statement[2:]:
		data.append(value.split()[0])
		total_revenue.append(value.split()[1])
