...
class Vacancies(StatesGroup):
    ...
    Пользователь может запросить вакансии с учётом опредлённого направления:
    - Производство
    - IT & Digital
    - Офис
    - Молодым специалистам
    После этого необходимо выбрать город, в котором данные
    вакансии существуют на данный момент.

    У каждого направления индивидуальный подбор городов,
    посмотреть все возможные варианты можно в файле keyboard.py
    """
...
class Capitals(StatesGroup):
    ...
    Пользователь может выбрать один из отчётов компании:
    - Общий доход компании
    - Акционерный капитал компании
    - Чистая прибыль

    При выборе отчёта нужно указать временной период,
    интересующий пользователя в данный момент. Доступны два периода:
    - Квартальный
    - Годовой
    """
