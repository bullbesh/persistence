"""Модуль для получения вакансий по направлению 'IT & Digital'."""
...
def get_it_and_digital_vacations():
    """Плучение вакансий для работы в IT.
    Эта функция запрашивает код у страницы, обрабатывает её,
    на выходе выдаёт список словарей с вакансиями.
    """
    driver = webdriver.Chrome()
    driver.get(
        "https://career.severstal.com/vacancies/?direction=IT+%26+Digital"
    )
