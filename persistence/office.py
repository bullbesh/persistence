...
FILE = ['office_belgorod.txt', 
	'office_voroneg.txt',
	'office_moscow.txt',
	'office_eagle.txt',
	'office_yaroslavl.txt',
	'office_vorkuta.txt',
	'office_kolpino.txt',
	'office_olenegorsk.txt',
	'office_saint_petersburg.txt',
	'office_cherepovets.txt',
	'office_novosibirsk.txt',
	'office_kazan.txt'
	]
...
def save_file(path):
	with open(path[0], 'w', encoding='utf-8') as file:
		if vacations_in_belgorod == []:
			file.write('К сожалению в Белгороде сейчас нет работы в офисе' + '\n')
		else:
	...
	with open(path[1], 'w', encoding='utf-8') as file:
		if vacations_in_voroneg == []:
			file.write('К сожалению в Воронеже сейчас нет работы в офисе' + '\n')
		else:
	...
	with open(path[2], 'w', encoding='utf-8') as file:
		if vacations_in_moscow == []:
			file.write('К сожалению в Москве сейчас нет работы в офисе' + '\n')
		else:
	...
	with open(path[3], 'w', encoding='utf-8') as file:
		if vacations_in_eagle == []:
			file.write('К сожалению в Орле сейчас нет работы в офисе' + '\n')
		else:
	...
	with open(path[4], 'w', encoding='utf-8') as file:
		if vacations_in_yaroslavl == []:
			file.write('К сожалению в Ярославле сейчас нет работы в офисе' + '\n')
		else:
	...
	with open(path[5], 'w', encoding='utf-8') as file:
		if vacations_in_vorkuta == []:
			file.write('К сожалению в Воркуте сейчас нет работы в офисе' + '\n')
		else:
	...
	with open(path[6], 'w', encoding='utf-8') as file:
		if vacations_in_kolpino == []:
			file.write('К сожалению в Колпино сейчас нет работы в офисе' + '\n')
		else:
	...
	with open(path[7], 'w', encoding='utf-8') as file:
		if vacations_in_olenegorsk == []:
			file.write('К сожалению в Оленегорске сейчас нет работы в офисе' + '\n')
		else:
	...
	with open(path[8], 'w', encoding='utf-8') as file:
		if vacations_in_saint_petersburg == []:
			file.write('К сожалению в Санкт-Петербурге сейчас нет работы в офисе' + '\n')
		else:
	...
	with open(path[9], 'w', encoding='utf-8') as file:
		if vacations_in_cherepovets == []:
			file.write('К сожалению в Череповце сейчас нет работы в офисе' + '\n')
		else:
	...
	with open(path[10], 'w', encoding='utf-8') as file:
		if vacations_in_novosibirsk == []:
			file.write('К сожалению в Новосибирске сейчас нет работы в офисе' + '\n')
		else:
	...
	with open(path[11], 'w', encoding='utf-8') as file:
		if vacations_in_kazan == []:
			file.write('К сожалению в Казани сейчас нет работы в офисе' + '\n')
		else:
